...
namespace ms
{
    namespace omp
    {
        namespace stat
        {
            ...
            std::vector<utils::vec<T, D>> cluster_points(utils::mat<T, N, D> &data, const size_t niter, const float bandwidth, const float radius, const float min_distance, const size_t num_threads)
            {
